...
const UserDetail: React.FC = () => {
  ...
  const handleDelete = async () => {
    if (!user || !window.confirm(`Are you sure you want to delete ${user.name}?`)) return;
          ...
          <div className="floating-card">
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="p-4 glass-input rounded-xl bg-white/20">
              ...
              <div>
                ...
                <div className="p-4 glass-input rounded-xl bg-white/20 min-h-[100px]">
                  {user.bio ? (
      ...
      <div className="floating-card">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <div className="p-3 glass-input rounded-xl bg-white/20">
