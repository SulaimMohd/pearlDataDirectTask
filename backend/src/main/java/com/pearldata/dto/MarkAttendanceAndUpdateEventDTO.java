...
public class MarkAttendanceAndUpdateEventDTO {
    ...
    private Boolean markEventAsCompleted = false; // Optional flag to mark event as completed

    // Constructors
    public MarkAttendanceAndUpdateEventDTO() {}

    public MarkAttendanceAndUpdateEventDTO(Long eventId, List<AttendanceRecordDTO> attendanceRecords, Boolean markEventAsCompleted) {
        this.eventId = eventId;
        this.attendanceRecords = attendanceRecords;
        this.markEventAsCompleted = markEventAsCompleted;
    }
    ...
    public Boolean getMarkEventAsCompleted() {
        return markEventAsCompleted;
    }

    public void setMarkEventAsCompleted(Boolean markEventAsCompleted) {
        this.markEventAsCompleted = markEventAsCompleted;
    }

    @Override
    public String toString() {
        return "MarkAttendanceAndUpdateEventDTO{" +
                "eventId=" + eventId +
